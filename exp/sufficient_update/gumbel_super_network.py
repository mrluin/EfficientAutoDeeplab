...
class GumbelAutoDeepLab(MyNetwork):
    ...
    def single_path_forward(self, x, single_path):
        ...
        for layer in range(self.nb_layers): # single_path loop layer-index w.r.t. output of stem2
            ...
            state = _single_path_gdas_weightsum(layer, current_scale, next_scale, cell_index, self.network_arch_index, self.network_arch_hardwts,
    ...
    def get_aspp_hardwts_index(self):
        ...
        self.aspp_arch_hardwts = aspp_hardwts
    ...
    def get_network_arch_hardwts(self):
        ...
        self.network_arch_hardwts = hardwts
