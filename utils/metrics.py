...
class Evaluator(object):
    ...
    def Precision(self):
        ...
        P_per_class = true_positive / predicted_condition_positive # TP / (TP+FP)
    ...
    def Recall(self):
        ...
        R_per_class = true_positive / condition_positive # TP/P
    ...
    def Fx_Score(self, x=1):
        ...
        F = ((x * x + 1) * P_per_class * R_per_class) / (x * x * P_per_class + R_per_class)
        F = np.nanmean(F)
        return F
