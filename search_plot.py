...
# loss window_3810e671e6ddba # miou window_3810e671e81e28
json_dict1 = json.load(f1)
f1.close()
#print(json_dict['jsons']['window_380ccf45caf6f6']['title'])
x1 = json_dict1['jsons']['window_3810e671e6ddba']['content']['data'][0]['x']
y1 = json_dict1['jsons']['window_3810e671e6ddba']['content']['data'][0]['y']
...
f2.close()
x2 = json_dict2['jsons']['window_380c721b6ede3e']['content']['data'][0]['x']
y2 = json_dict2['jsons']['window_380c721b6ede3e']['content']['data'][0]['y']
